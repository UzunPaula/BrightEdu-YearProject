...
// Factory Method concret: creează blocuri de tip Text.
public sealed class TextContentBlockCreator : ILessonContentBlockCreator
{
    ...
    public LessonContentBlock Create(Guid lessonId, int order, string configJson)
        => new(Guid.NewGuid(), lessonId, order, ContentBlockType.Text, configJson);
}
